...
def main():
    print("=" * 55)
    print("Qwen Self-Data Generation")
    print(f"   Target: {TARGET} conversations")
    ...
    if out_path.exists():
        ...
        print(f"Found: {done} conversations — continuing\n")
    ...
    with open(out_path, "a", encoding="utf-8") as f:
        while done < TARGET:
            ...
            if conv:
                ...
                if errors >= 10:
                    print("10 errors — waiting 5s and continuing")
                    time.sleep(5)
                    errors = 0
    ...
    print(f"\nCompleted! {done} conversations in {OUTPUT_FILE}")
    split_dataset()
