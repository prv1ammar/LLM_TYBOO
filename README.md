...
└────────────────┬────────────────────┘
                 ...
                 ▼
┌─────────────────────────────────────┐
│  Step 2: Intent Classifier          │  ← Qwen 0.5B fine-tuné
│          → intent + tags            │  ← question_info / complaint / ...
└────────────────┬────────────────────┘
                 │ intent + tags
                 ▼
┌─────────────────────────────────────┐
│  Step 1: LLM (Qwen 0.5B / 1.5B)    │  ← Fine-tuné sur data anti-répétition
...
│   └── classifier.py        # Fine-tuning + inference Qwen intent
│
├── step3_guardrails/
...
# → models/qwen_intent_finetuned/

# 5. Launch API (Step 5 — orchestre Steps 2,3,4)
cd ../step5_api
python api.py
# → http://localhost:8000
```
...
| Intent classifier | Qwen2.5-0.5B fine-tuné | ~1GB | Step 2 |
